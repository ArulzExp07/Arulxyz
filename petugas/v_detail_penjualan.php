        ...
        ?>
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable green">
                        ...
                        <div class="price-value" style="font-size:medium;">WELCOME
                            <span class="month"></span>
                        </div>
                        <ul class="pricing-content">
                            <li><b>ID PELANGGAN:</b><?= $pelanggan['id_pelanggan'] ?></li>
                            <li><b>NAMA PELANGGAN:</b><?= $pelanggan['nama_pelanggan'] ?></li>
                            <li><b>ALAMAT</b><?= $pelanggan['alamat'] ?></li>
    ...
    <table class="table table-dark">
                    ...
                    <td>
                        <form action="m_update_barang_detail.php" method="post">
                            ...
                            <select name="id_barang" id="" onchange="this.form.submit()">
                                <?php
                                foreach ($dataBarang as $barang) {
                                ?> <option value="<?= $barang['id_barang'] ?>" <?php if ($barang['id_barang'] == $detail['id_barang']) echo "selected"; ?>>
        ...
        <form action="m_hitung_total.php" method="post">
            ...
            <tr>
                <td colspan="2"></td>
                <td>Bayar</td>
                <td><input type="number" name="bayar" id="bayar" onchange="this.form.submit()" tabindex="1">
                </td>
                <td colspan="2"></td>
            </tr>
            <tr>
