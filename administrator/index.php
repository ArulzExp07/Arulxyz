        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 10rem;">
                    <img src="../img/barang.jpg" class="card-img-top" alt="..." height="124px">
                    <div class="card-body">
                        <p class="card-text">
            ...
            <div class="col">
                <div class="card" style="width: 10rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            <button type="button" class="btn btn-primary">
                                Pembelian <span class="badge text-bg-secondary">
                                    <?= $jumlahPenjualan['Jumlah']; ?></span>
                            </button>
                        </p>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card" style="width: 10rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            <button type="button" class="btn btn-primary">
                                Pelanggan <span class="badge text-bg-secondary">
                                    <?= $jumlahPelanggan['Jumlah']; ?></span>
                            </button>
                        </p>
                    </div>
                </div>
