        ...
        <form action="m_ubah_barang.php" method="post">
            ...
            <table>
                <tr>
                    <td>Nama Barang</td>
                    <td>:</td>
                    <td><input type="text" name="nama_barang" id="" value="<?= $barang['nama_barang'] ?>"
                            class="form-control"></td>
                </tr>
                <tr>
                    <td>Stok Barang</td>
                    <td>:</td>
                    <td><input type="text" name="stok_barang" id="" value="<?= $barang['stok_barang'] ?>"
                            class="form-control"></td>
                </tr>
                <tr>
                    <td>Harga</td>
                    <td>:</td>
                    <td><input type="text" name="harga_barang" id="" value="<?= $barang['harga_barang'] ?>"
                            class="form-control"></td>
                </tr>
                <tr>
                    <td></td>
